...
const MODULES: {
    ...
    href: string,
}[] = [
        {
            icon: 'layout_tree',
            title: "Диаграммы",
            description: "Создавайте блок-схемы, интеллект-карты и визуальные модели процессов. Настраивайте цвета, иконки, шрифты и связи, чтобы визуализировать архитектуру проекта, структуру команды или пользовательский путь. Идеально подходит для документирования, анализа и презентаций.",
            href: "/diagram",
        },
        {
            icon: 'layout_tree',
            title: "Формулы",
            description: "Определяйте структуры через текстовые формулы с мгновенной визуализацией. Инновационный способ описывать диаграммы через текстовые формулы. Используйте интуитивный синтаксис для построения сложных логических структур и связей. Любое изменение в формуле мгновенно отображается на схеме — и наоборот.",
            href: "/diagram-formula",
        },
        {
            icon: "filter",
            title: "Воронки",
