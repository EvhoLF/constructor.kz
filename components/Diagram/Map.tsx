...
import { defaultEdgeOptions, lineStyle } from "./MapConfig";
...
const Map = ({ id }: { id: string }) => {
  ...
  return (
    <div style={{ width: "100%", height: "100%" }}>
      ...
      >
        <Background variant={BackgroundVariant.Lines} color={lineStyle(mode)} size={1} gap={20} />
                ...
                <Stack direction="row" gap={2}>
                  ...
                  <Frame sx={{ padding: "5px" }}>
                    <Stack direction="row" gap={1}>
                      ...
                      <Tooltip title="Снимок диаграммы">
                ...
                <Stack direction="row" gap={2}>
                  <Frame sx={{ padding: "5px", width: "fit-content" }}>
                    <Stack direction="row">
                      ...
                      <Tooltip title="Показать всю диаграмму">
