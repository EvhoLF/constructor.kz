...
const NodeTemplates = () => {
  ...
  const showModalFormEdit = (id: number, title: string, category: string) => () => {
    showModal({ content: (<ModalFormNodeTemplateEdit api={templateApi} id={id} title={title} category={category} setTemplates={setNodeTemplates} />) });
  };

  const showModalFormDelete = (id: number, title: string) => () => {
    showModal({ content: (<ModalFormNodeTemplateDelete api={templateApi} id={id} title={title} setTemplates={setNodeTemplates} />) });
  };
