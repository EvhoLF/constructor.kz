...
interface KanbanListItemProps extends Pick<IKanbanFunnel, "id" | "title"> {
    ...
    >
      ...
      >
        ...
        <Stack
          ...
          direction="row"
        >
          <Tooltip title="Открыть канбан воронку">
            <Link href={url} passHref>
          ...
          <Tooltip title="Редактировать канбан воронку">
            <IconButton onClick={onEdit(id, title)} size="small">
              <Icon icon="edit" />
            </IconButton>
          </Tooltip>
          <Tooltip title="Удалить канбан воронку">
            <IconButton
