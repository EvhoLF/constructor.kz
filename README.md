...
1. **Онтологии**
   ...
   - Двусторонняя связь: изменения формулы ↔ изменения диаграммы
   - Импорт блоков и диаграмм из шаблонов

2. **Создание диаграмм без формул**

   - Визуальный редактор блок-диаграмм
...
3. **Шаблоны диаграмм**
   ...
   - Вставка блоков или целых диаграмм в обычные диаграммы
...
- **Funnel** — воронки
- **Kanban** — канбан-доски
- **TemplateDiagram / TemplateOntology** — шаблоны диаграмм
...
2. Создай папку для сертификатов
...
3. Запусти Certbot в контейнере для выдачи сертификата
...
sudo docker run -it --rm \
  ...
  -d konstruktor.kz -d www.konstruktor.kz
```
