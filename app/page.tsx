        ...
        <Stack paddingX={{ xs: 2, sm: 4, md: 10, }} spacing={3} gap={7}>
          ...
          <Stack justifyContent='center' gap={1}>
            ...
            <Typography variant="body1">
              ...
              Она помогает командам любого размера превращать сложные идеи и данные в понятные визуальные диаграммы, ускоряя принятие решений и повышая прозрачность процессов.
            </Typography>
          </Stack>
